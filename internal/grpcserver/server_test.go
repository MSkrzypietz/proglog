...
import (
	...
	"github.com/MSkrzypietz/proglog/internal/auth"
	"github.com/MSkrzypietz/proglog/internal/config"
	"github.com/MSkrzypietz/proglog/internal/log"
...
func TestServer(t *testing.T) {
	for scenario, fn := range map[string]func(t *testing.T, rootClient api.LogClient, nobodyClient api.LogClient, cfg *Config){
...
func setupTest(t *testing.T, fn func(cfg *Config)) (rootClient api.LogClient, nobodyClient api.LogClient, cfg *Config, teardown func()) {
	t.Helper()
